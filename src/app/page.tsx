  ...
  return (
    <main className='flex min-h-screen flex-col items-center p-24'>
      ...
      <Link href={'/clients'} className='flex flex-col'>
        <div className='flex rounded-full items-center p-2 text-myOrange bg-myYellow hover:bg-myOrangeBg hover:text-white focus:ring-2 focus:ring-white transition duration-200 ease-in-out transform hover:scale-110 mt-5'>
